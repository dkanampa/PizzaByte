...
public:
	...
	// In-game time remaining until next order
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category = "Orders",
		META = (UIMin = -1440.0f, UIMax = 0.0f))
		float NextOrderDeltaTime = 30.0f;
